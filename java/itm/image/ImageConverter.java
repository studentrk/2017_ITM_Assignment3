    ...
    */
	protected File processImage( File input, File output, String targetFormat, float quality ) throws IOException, IllegalArgumentException
    {
        ...
        try {
            ...
            throw new IllegalArgumentException("Das File konnte nicht gelesen werden.");
        }
        ...
        if (targetFormat.equalsIgnoreCase("jpeg")){
            ...
            jpgWriteParam.setCompressionMode(ImageWriteParam.MODE_EXPLICIT);//explicit, da wir die Kompressionsqualität selbst angeben
        ...
        } else if(targetFormat.equalsIgnoreCase("bmp") || targetFormat.equalsIgnoreCase("png")){
            try {
                ...
                throw new IllegalArgumentException("Das File konnte nicht geschrieben werden.");
            }
